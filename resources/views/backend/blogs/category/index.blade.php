                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header row">
                            <h3 class="card-title col-md-12">Blog Category: <a href="{{route('blogs-category.create')}}" class="btn btn-success float-right">Add Category</a></h3>
                        </div>
                        <div class="card-body">
                                        ...
                                        @foreach ($categories as $detail)
                                            <tr>
                                                ...
                                                <td class="text-center align-middle">
                                                    <form action="{{ route('blogs-category.destroy', $detail->id) }}" method="POST">
                                                        <div class="btn-group align-top btn-list">
                                                            <a class="btn btn-sm btn-primary badge" href="{{ route('blogs-category.edit', $detail->id) }}"><i class="fa fa-edit"></i></a>
