    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <h1 class="page-title">Add Company Information</h1>
                <div>
                    <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <form action="{{ route('company-information.store') }}" method="POST">
                            @csrf
                        
                            <div class="card-header">
                                <div class="card-title">Add New Company Information</div>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="card-footer">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <button type="submit" class="btn btn-primary">Add New Company Information</button>
