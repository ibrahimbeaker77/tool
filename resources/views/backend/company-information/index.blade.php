                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header row">
                            <h3 class="card-title col-md-12">Company Information: <a href="{{route('company-information.create')}}" class="btn btn-success float-right">Add Company Information</a></h3>
                        </div>
                        <div class="card-body">
                                        ...
                                        @foreach ($information as $detail)
                                            <tr>
                                                ...
                                                <td class="text-center align-middle">
                                                    <form action="{{ route('company-information.destroy', $detail->id) }}" method="POST">
                                                        <div class="btn-group align-top btn-list">
                                                            <a class="btn btn-sm btn-primary badge" href="{{ route('company-information.edit', $detail->id) }}"><i class="fa fa-edit"></i></a>
