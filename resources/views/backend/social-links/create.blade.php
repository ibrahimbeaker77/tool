    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <h1 class="page-title">Add Social Link</h1>
                <div>
                    <ol class="breadcrumb">
                    ...
                    <div class="card">
                        <form action="{{ route('social-links.store') }}" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    <label class="col-md-3 form-label">Social icon :</label>
                                    <div class="col-md-9">
                            ...
                            <div class="card-footer">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <button type="submit" class="btn btn-primary">Add New Social Link</button>
